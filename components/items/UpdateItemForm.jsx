...
const UpdateItemForm = ()=>{
  ...
  const addItemHandler = async (e) => {
    e.preventDefault();
    let mappedIngredients = ingredients.map(ingredient => ({ value: ingredient.value }));
    ...
    return(
        ...
        <div className="flex justify-center items-center p-4" key={index}>
          ...
          />
          <Image src="/close.svg" className="cursor-pointer" width={40} height={40} alt="image" onClick={() => removeIngredient(index)} />
        </div>
      ))}
      <div className="flex justify-center items-center p-4 cursor-pointer">
        <div className="bg-custom w-full rounded h-15 p-6 flex justify-center items-center text-purpleText font-semibold border border-dashed border-purpleText border-2" onClick={addIngredient}>
          Add Ingredients
        </div>
      </div>
        ...
        <div className="flex justify-center items-center p-4" key={index}>
          ...
          />
          <Image src="/close.svg" className="cursor-pointer" width={40} height={40} alt="image" onClick={() => removeStep(index)} />
        </div>
      ))}
      <div className="flex justify-center items-center p-4 cursor-pointer">
        <div className="bg-custom w-full rounded h-15 p-6 flex justify-center items-center text-purpleText font-semibold border border-dashed border-purpleText border-2" onClick={addStep}>
          Add Steps
        </div>
      </div>

          <div className="flex justify-center items-center mt-4 p-4 cursor-pointer" onClick={addItemHandler}>
